...
def respond(voice_data):
    ...
    #7: get stock price
    if there_exists(["stock price"]):
        search_term = voice_data.split("of")[-1]
        url = "https://google.com/search?q=" + search_term + "stock price"
        webbrowser.get().open(url)
        engine_speak("Here is what I found for " + search_term + " on google")
    ...
    if there_exists(["want to do shopping"]):
        search_term = voice_data.split("for")[-1]
        url="https://www.amazon.in"+search_term
        webbrowser.get().open(url)
        engine_speak("Opening amazon.com for you sir, hope you buy something for me as well")
         
    #make a note
    if there_exists(["note"]):
        search_term=voice_data.split("for")[-1]
    ...
    #open instagram
    if there_exists(["open instagram","want to have some fun time","i am bored"]):
        search_term=voice_data.split("for")[-1]
        url="https://www.instagram.com/"
        webbrowser.get().open(url)
        engine_speak("opening instagram, let's chill")
    ...
    #8 time table
    if there_exists(["schedule"]):
        im = Image.open(r"C:\Users\akash\OneDrive\Desktop\WhatsApp Image 2023-02-20 at 17.14.05.jpg")
        im.show()
    ...
    if there_exists(["game"]):
        ...
        if pmove==cmove:
            ...
            engine_speak("Congratulations You win, but i will get you another time")
        elif pmove== "rock" and cmove== "paper":
            engine_speak("I win, you can't defeat me")
    ...
    #12 calc
    if there_exists(["plus","minus","into","divide","power","+","-","*","/"]):
    ...
    if there_exists(["wow", "thank you", "you are amazing"]):
        engine_speak("You are welcome, Thanks to you and your team for creating me") 
